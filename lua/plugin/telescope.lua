...
local function telescope_cfg()
	...
	vim.keymap.set("n", "<leader>tb", builtin.buffers, { noremap = true, nowait = true, desc = "Telescope buffers" })
	vim.keymap.set("n", "<leader>to", builtin.oldfiles, { noremap = true, nowait = true, desc = "Telescope old files" })
	vim.keymap.set(
		"n",
		"<leader>ts",
