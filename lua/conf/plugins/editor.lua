...
return {
	require('conf/plugins/editor/tcomment_vim'),  -- An extensible & universal comment vim-plugin that also handles embedded filetypes. in <space>cn to comment a line.
	require('conf/plugins/editor/vim-illuminate'),  -- automatically highlighting other uses of the current word under the cursor
	require('conf/plugins/editor/bullets'),  -- Bullets.vim is a Vim/NeoVim plugin for automated bullet lists.
	-- {
