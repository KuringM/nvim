...
-- 替换整篇文本中的中文标点
function M.replace_punctuation()
...
function M.setup_keymap()
  vim.keymap.set("n", "<C-s>", M.replace_punctuation, { desc = "Replace Chinese punctuation", noremap = true, silent = true })
  vim.keymap.set("i", "<C-s>", function()
    vim.cmd("stopinsert")
    vim.schedule(M.replace_punctuation)
